...
static const uint8_t axs15231b_320480_type1_init_operations_local[] = {
    BEGIN_WRITE,
...
void Arduino_AXS15231B_JC3248::tftInit()
{
  ...
  _bus->batchOperation(axs15231b_320480_type1_init_operations_local, sizeof(axs15231b_320480_type1_init_operations_local));

  _bus->beginWrite();
  _bus->writeC8D8(AXS15231B_COLMOD, 0x55);
  _bus->writeC8D16D16(AXS15231B_PTLAR, 0x0000, 0x01DF);
